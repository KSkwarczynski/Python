...
h_13_cp = TH2D("13_cp","", binning,deltacp_l, deltacp_u, binning, sin13_l, sin13_u)
h_23_cp = TH2D("23_cp","", binning, deltacp_l, deltacp_u ,binning, sin23_l, sin23_u)
h_d23_23 = TH2D("d23_23","",binning, delm23_l, delm23_u, binning, sin23_l, sin23_u)
h_d23_13 = TH2D("d23_13","",binning, delm23_l, delm23_u, binning, sin13_l, sin13_u)
...
h_LogL = TH1D("LogL","",binning, 0, 10000)
h_13_LogL = TH2D("13logl","",binning, sin13_l, sin13_u, binning, 0, 10000)
h_23_LogL = TH2D("23logl","",binning, sin23_l, sin23_u, binning, 0, 10000)
...
if(True):
	...
	ttree.SetBranchAddress("sin2th_12", AddressOf(mcmc_tree, "sin2th_12"))
	...
	for e in range(nburn, ttree.GetEntries()):
		ttree.GetEntry(e)
		h_13_cp.Fill(mcmc_tree.delta_cp, mcmc_tree.sin2th_13)
		h_23_cp.Fill(mcmc_tree.delta_cp, mcmc_tree.sin2th_23)
...
h_13_cp.GetYaxis().SetTitle("sin^{2}(#theta_{13})")
h_13_cp.GetXaxis().SetTitle("#delta_{cp}")
h_13_cp.Draw("COLZ")
...
h_23_cp.GetYaxis().SetTitle("sin^{2}(#theta_{23})")
h_23_cp.GetXaxis().SetTitle("#delta_{cp}")
h_23_cp.Draw("COLZ")
...
fcanv.SaveAs(webloc + "/Oscylacje.pdf")
...
h_projection.Draw()
#h_13.Draw("SAME")
canv2.SaveAs(webloc + "/fit_misc.pdf")
